        ...
        <div className={st.card}>
            {
                loading
                    ...
                    : <>
                        {onPlus && <div className={st.favorite}>
                            <img onClick={onClickFavorite} width={32} height={32} src={isFavorite ? liked : unliked} alt="unliked" />
                        </div>}
                        ...
                        <div className={st.price}>
                            ...
                            {onPlus && <img className={st.plus} onClick={onHandle} width={32} height={32} src={isItemAdded(id) ? cheked : plus} alt="plus" />}
                        </div>
                    </>
            }
